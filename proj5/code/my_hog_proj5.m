...
features_pos = my_hog_get_positive_features( train_path_pos, feature_params );
num_negative_examples = 10000; %Higher will work strictly better, but you should start with 10000 for debugging
features_neg = my_hog_get_random_negative_features( non_face_scn_path, feature_params, num_negative_examples);
...
% size(training_data)
[w, b] = vl_svmtrain(training_features', training_labels', 0.00009);
