...
% pic_a = imresize(pic_a, 0.3, 'bilinear');
% pic_b = imresize(pic_b, 0.3, 'bilinear');
...
pic_a = imresize(pic_a, 0.35, 'bilinear');
pic_b = imresize(pic_b, 0.35, 'bilinear');
...
% pic_a = imresize(pic_a, 0.25, 'bilinear');
% pic_b = imresize(pic_b, 0.25, 'bilinear');
