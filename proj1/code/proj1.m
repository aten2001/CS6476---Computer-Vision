...
figure(3); imshow(vis);
imwrite(low_frequencies, 'low_frequencies_bp3.jpg', 'quality', 95);
imwrite(high_frequencies + 0.5, 'high_frequencies_bp3.jpg', 'quality', 95);
imwrite(hybrid_image, 'hybrid_image_bp3.jpg', 'quality', 95);
imwrite(vis, 'hybrid_image_scales_bp3.jpg', 'quality', 95);