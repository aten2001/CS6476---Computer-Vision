...
% old_test_image_feats = test_image_feats;
% old_test_labels = test_labels;
% old_test_image_paths = test_image_paths;
% old_train_image_paths = train_image_paths;
% old_train_labels = train_labels;
% old_train_image_feats = train_image_feats;
...
% test_data_size = size(test_image_feats,1);
% indices = randsample(test_data_size, 100);
% test_image_feats = test_image_feats(indices,:);
% test_labels = test_labels(indices);
% test_image_paths = test_image_paths(indices);
% 
% train_data_size = size(train_image_paths,1);
% indices = randsample(train_data_size, 1000);
% train_image_paths = train_image_paths(indices);
% train_labels = train_labels(indices);
% train_image_feats = train_image_feats(indices,:);
